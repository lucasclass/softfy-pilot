  ...
  return (
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[280px]">
        ...
        Comece a monitorar suas vendas como um profissional
        </h1>
        <p className="text-center pt-6 text-[#36485C] lg:text-[18px] lg:leading-7">
        Descubra as melhores ferramentas de análise e gestão para tomar decisões inteligentes e otimizar ao máximo o seu negócio.
        </p>
