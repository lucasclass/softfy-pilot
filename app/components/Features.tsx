    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px] ">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          Simplifique seu monitoramento de vendas
          </h1>
          <Image
            src={Feature1}
            alt="feature 1 image"
          ...
          Fique por dentro de tudo e renove seu processo de trabalho com nosso recurso revolucionário. 
          Obtenha uma visão panorâmica com nosso painel personalizável.
          </p>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          />
          <p className="py-[24px] text-[#36485C] lg:text-[18px]">
            Saiba em detalhes tudo o que seus concorrentes vendem e fazem: 
            os produtos mais vendidos, mudanças de preços, novas publicações e exclusões, 
            e tudo o que você precisa para manter suas vendas sob controle.
          </p>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          />
          <p className="py-[24px] text-[#36485C] lg:text-[18px]">
          Navegue por todas as categorias do Mercado Livre e descubra milhares de oportunidades,
           acessando tendências, rankings dos produtos mais vendidos e os melhores vendedores. 
           Tome decisões com informações reais.
          </p>
